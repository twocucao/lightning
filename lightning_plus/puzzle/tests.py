...
from lightning_plus.puzzle.models import Block
from lightning_plus.puzzle.services import move
...
class BlockMoveTest(TestCase):
    ...
    def assertChildren(self, parent, children_id):
        self.assertListEqual(
            children_id, list(parent.children.values_list("id", flat=True))
        )
