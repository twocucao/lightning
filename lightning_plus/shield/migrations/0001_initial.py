...
model_field = (
    partial(
        models.ForeignKey, on_delete=django.db.models.deletion.CASCADE, to="meta.Model"
    )
    if hasattr(settings, "SHIELD_MODEL")
    else partial(models.CharField, max_length=191)
)
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("model", model_field(verbose_name="关联模型")),
                (
                    "groups",
