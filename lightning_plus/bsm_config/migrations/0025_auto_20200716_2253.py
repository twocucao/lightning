...
def update_value_json(apps, schema_editor):
    ...
    for setting in settings:
        if setting.value:
            ...
            setting.value_json = {
                "value": bool_mapping[setting.value]
                if setting.value in bool_mapping
                else setting.value
            }
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name="setting",
            name="groups",
            field=lightning_plus.api_basebone.core.fields.JSONField(
                default=[], verbose_name="指定角色可看"
            ),
        ),
        migrations.AddField(
            model_name="setting",
