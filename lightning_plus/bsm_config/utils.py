...
def check_page(old_page, new_page, old_type, new_type):
    ...
    if (old_page in page1 and new_page in page1) or (
        old_page in page2 and new_page in page2
    ):
        return False
    else:
        return True
    ...
    if not menu.permission:
        ...
        if menu.page in MODEL_PAGES:
            ...
            permission, _ = Permission.objects.get_or_create(
                codename=f"view_{model}", content_type=content_type
            )
