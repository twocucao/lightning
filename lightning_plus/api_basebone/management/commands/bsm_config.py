...
from lightning_plus.api_basebone.export.fields import get_app_field_schema
from lightning_plus.api_basebone.export.admin import get_app_admin_config
    ...
    def _get_admin_config(self, action):
        ...
        try:
            ...
            admin_file = os.path.join(
                settings.FRONT_END_PROJECT_PATH, "src/admin/index.js"
            )
    ...
    def _get_schema_config(self, action):
        ...
        try:
            ...
            schema_file = os.path.join(
                settings.FRONT_END_PROJECT_PATH, "src/schemas/config.json"
            )
