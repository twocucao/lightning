        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ordering",
                    models.CharField(
                        blank=True, default="", max_length=50, verbose_name="排序"
                    ),
                ),
                (
                    "func_name",
                    models.CharField(
                        blank=True, default="", max_length=50, verbose_name="云函数名称"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.IntegerField(
                        choices=[("CONTAINER", "容器"), ("CHILD", "单一条件")],
                        verbose_name="条件类型",
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="api_basebone.Filter",
                        verbose_name="parenet",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "default",
                    models.CharField(
                        default="", max_length=50, null=True, verbose_name="默认值"
                    ),
                ),
                (
                    "api",
