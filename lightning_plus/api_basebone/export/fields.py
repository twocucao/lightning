...
from lightning_plus.api_basebone.core.fields import ObjectField, ArrayField
    ...
    for item in fields:
        ...
        if field_type is not None:
            ...
            if function is not None:
                ...
                config.append(
                    field_config_instance.normal_field_params(item, data_type)
                )
...
def get_app_json_field_schema():
    ...
    return (
        ...
        {
            f"array_item_model__{key}": value
            for key, value in array_field_config.items()
        },
    )
