...
class WeChatLogistics(BaseWeChatAPI):
    def add_order(
        ...
        return self._post("express/business/order/add", data=data)
    ...
    def get_quota(self, delivery_id, biz_id):
        ...
        return self._post("express/business/quota/get", data={delivery_id, biz_id})
    ...
    def test_update_order(
        ...
        return self._post("express/business/test_update_order", data=data)
