...
from lightning_plus.api_basebone.core.decorators import (
    BSM_BATCH_ACTION,
    BSM_CLIENT_BATCH_ACTION,
)
...
common_action_map = {"delete": delete, "nowEdit": patch}
...
def get_model_batch_actions(model, end=MANAGE_END_SLUG):
    ...
    if action_module:
        end_map_name = (
            BSM_BATCH_ACTION if end == MANAGE_END_SLUG else BSM_CLIENT_BATCH_ACTION
        )
