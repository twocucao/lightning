...
from lightning_plus.api_basebone.core import exceptions
from ..core import admin
from lightning_plus.api_basebone.drf.response import success_response
from . import const
from lightning_plus.api_basebone.restful.serializers import get_model_exclude_fields
from lightning_plus.api_basebone.utils.meta import get_all_relation_fields
from lightning_plus.api_basebone.utils.meta import get_bsm_model_admin
...
from lightning_plus.api_basebone.services.expresstion import resolve_expression
...
class FormMixin(object):
    ...
    def get_create_form(self):
        ...
        return get_form_class(
            self.model, "create", end=self.end_slug, request=self.request
        )

    def get_update_form(self):
        """获取更新数据的验证表单"""
        return get_form_class(
            self.model, "update", end=self.end_slug, request=self.request
        )
